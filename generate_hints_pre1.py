...
def main():
    ...
    print(f"Found {len(matches)} chunks to process.")
    ...
    for i, match in enumerate(matches):
        ...
        print(f"Processing ({i+1}/{len(matches)}): {answer[:30]}...")
    ...
    print(f"Done! Successfully updated {count} out of {len(matches)} chunks.")
